    ...
    <main>
      <div ref={ref} className="relative z-10 h-[200vh] overflow-clip">
        <motion.div
          style={{ scale }}
          className={cn(
            "sticky left-0 top-0 grid h-screen origin-[50%_70%] gap-2 p-6 pt-12 [grid-template-rows:4fr_1fr] md:origin-[90%_40%] md:pt-20",
            "hero-background"
          )}
        >
          <div
            className={cn(
              "flex flex-col rounded-3xl text-black bg-white p-12 md:flex-row",
              "window-mask"
            )}
          >
            <div className="flex h-full flex-col">
              <h1 className="mb-5 max-w-[12ch] text-4xl font-bold leading-[0.85] md:my-auto md:text-5xl xl:text-6xl">
                Playing with masks and Framer Motion.
              </h1>
              <p className="text-lg md:text-xl">
                This animation is inspired by the Runway.com homepage.
              </p>
            </div>
          ...
          <div className="grid grid-flow-row grid-cols-3 gap-2">
            ...
            <a className="flex items-center justify-center rounded-3xl bg-orange-400 text-center text-lg font-bold text-slate-900 md:text-3xl">
              Early Access
            </a>
          </div>
        </motion.div>
      ...
      <div className="space-y-[80px] bg-blue-600 md:text-[100px]">
